...
from c3000web_notificator.bots.core.vk.aiovk.user.user_events import DEFAULT_MODE, Event, VkEventType, VkLongpollMode
from c3000web_notificator.bots.core.vk.aiovk.vk_api import VkApi
...
class VkLongPoll(object):
    ...
    async def get_events(self):
        ...
        response = await self.vk._send(self.url, values, self.wait)
